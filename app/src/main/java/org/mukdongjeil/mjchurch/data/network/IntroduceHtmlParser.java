...
public class IntroduceHtmlParser {
    private static final String TAG = IntroduceHtmlParser.class.getSimpleName();
    ...
    @Nullable
    public IntroduceEntity parse(final String html) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(imgSrc) == false) {
                return new IntroduceEntity(title, NetworkUtils.BASE_URL + imgSrc);
            }
